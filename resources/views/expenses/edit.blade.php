<x-app-layout>
    <div class="container mx-auto mt-5">
        @if(session()->has('message'))
            <div id="flash-message" class="bg-green-500 text-white p-4 rounded-md mt-5 w-1/4 flex justify-between">
                {{ session()->get('message') }}
        ...
        @foreach($expenses as $expense_item)
            ...
            <form action="{{ route('expenses.update') }}" method="POST">
                ...
                <input type="hidden" name="expense_id" class="text-white bg-transparent" value="{{$expense_item->id}}">
                ...
                <input type="submit" value="Change" onclick="return confirm('Are You Sure Want to edit this?')" class="bg-gray-500 text-white p-2 rounded-md hover:bg-gray-600 mt-5">
            </form>
