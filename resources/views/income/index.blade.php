           ...
           @foreach($income as $income_item)
               <div  class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                   ...
                   <p  class="inline-flex font-medium items-center text-white">
                       ₦{{   number_format($income_item->amount, 0, '', ',')}}
                   ...
                   <div class="flex space-x-8">
                       ...
                       <form action="{{ url('income/delete',$income_item->id) }}" method="POST">
                           @csrf
                           <input type="hidden" name="id" value="{{$income_item->id}}">
       ...
       @else
           <div class="mt-10">
               ...
               <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                   ...
                   <a href="#">
                       <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">No Records of Income Found</h5>
                   </a>
                   <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">To create income, go to the create income page:</p>
                   <a href="{{ route('income.create') }}" class="inline-flex font-medium items-center text-blue-600 hover:underline">
                       Create new income
                       <svg class="w-3 h-3 ms-2.5 rtl:rotate-[270deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                           <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778"/>
                       </svg>
